# -*- coding: utf-8 -*-
"""
Created on Sun May 10 12:45:17 2020

@author: hanna
"""

'''
update: implementation of random generated graphs
'''
...
class Corpus_n(object):
    ...
    def categorise(self, uncategorized_G):
        ...
        for g in uncategorized_G:
            gcat = GraphSimulation(g, t_stop = 100.0, t_steps = 100)
...
class GraphSimulation(object):
    ...
    def __init__(self, G, t_stop = 100.0, t_steps = 100, initial = 0, target = 1):
        self.G = G
...
'''
corpus = Corpus_n(n = 10, target = 1, initial = 0)
corpus.generate_random_graphs(N = 10, total_random=True, verbose = 2)
'''